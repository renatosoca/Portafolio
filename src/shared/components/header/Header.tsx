  ...
  return (
    <header className="bg-white fixed w-full z-10">
      <div className=" w-full container flex justify-between items-center py-3">
        <Link to={'/'} className=" flex justify-center items-center gap-2 text-black font-bold text-2xl py-2">
        ...
        <nav className="flex gap-3 text-gray-500 font-medium ">
          <NavLink
            to="/"
            className={({ isActive }) =>
              `elative transition-[width] after:absolute after:content-[''] after:w-0 after:left-0 after:h-0.5 after:-bottom-1 after:bg-black after:duration-[400ms] hover:after:w-full ${isActive ? 'text-black' : ''}`
            }>
            Inicio
          </NavLink>
